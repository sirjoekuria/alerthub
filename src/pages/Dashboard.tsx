...
<div className="space-y-3 pt-6 border-t">
  ...
  <div className="grid grid-cols-3 gap-2 bg-muted p-1 rounded-xl">
    <button
      ...
      className={`flex items-center justify-center py-1.5 rounded-lg text-sm font-medium transition-all ${theme === "light"
    ...
    <button
      ...
      className={`flex items-center justify-center py-1.5 rounded-lg text-sm font-medium transition-all ${theme === "dark"
          ? "bg-primary text-primary-foreground shadow-sm"
          : "text-muted-foreground hover:text-foreground hover:bg-background/50"
        }`}
    >
    ...
    <button
      ...
      className={`flex items-center justify-center py-1.5 rounded-lg text-sm font-medium transition-all ${theme === "system"
          ? "bg-primary text-primary-foreground shadow-sm"
          : "text-muted-foreground hover:text-foreground hover:bg-background/50"
        }`}
    >
